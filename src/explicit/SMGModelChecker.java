...
public class SMGModelChecker extends ProbModelChecker
{
    ...
    */
	 ...
	 */
	protected StateValues checkExactProbabilityFormula(SMG smg, ExpressionProb expr, Coalition coalition, double p, BitSet statesOfInterest)
			throws PrismException
	{
	...
	protected StateValues checkExactRewardFormula(SMG smg, SMGRewards modelRewards, ExpressionReward exprRew, Coalition coalition, double p)
			throws PrismException
	{
